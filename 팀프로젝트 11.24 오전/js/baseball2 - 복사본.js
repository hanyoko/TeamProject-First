...
// function scoreUp(){
    // if(isComputer) {
    //     comScoreElem[turn].innerHTML = thisScore;
    //     totalScore += thisScore;
    //     console.log("컴퓨터 점수가 올라갑니다.");
    //     comTotalScoreElem.innerHTML = totalScore;
    // }else {
    //     userScoreElem[turn].innerHTML = thisScore;
    //     totalScore += thisScore;
    //     console.log("사용자 점수가 올라갑니다.");
    //     userTotalScoreElem.innerHTML = totalScore;
    // }
// }
...
//             comScoreElem.innerHTML = comTotalScoreElem;
//             console.log("turn:",turn);
            
//         }else {
//             // 사용자 턴
//             userScoreElem[Math.floor(turn/2)].innerHTML = user_score;
//             userScoreElem.innerHTML = userTotalScoreElem;
//             console.log("turn:",turn);
//         }
// }
