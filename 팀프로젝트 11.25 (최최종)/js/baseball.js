...
function btn1() {
    if(turn%2==0){
        ...
        if (com_strike < 6) { // com_strike가 1-5일 때
            noticeElem.innerHTML = ('컴퓨터가 HOMERUN을 쳤습니다 !');
            homerun = 1;
            com_score += roo+1
            sboclear();
            roo = 0;
        } else if (com_strike >= 6 && com_strike < 56) { // com_strike이 6-45일 때
            noticeElem.innerHTML = ('컴퓨터의 스트라이크 !');
            strike += 1;
        } else if (com_strike >= 56 && com_strike < 66) { // com_strike이 46-65일 때
        ...
        if (com_strike < 6) { // com_strike가 1-5일 때
            ...
            strike += 1;
        } else if (com_strike >= 56 && com_strike < 71) { // com_strike이 46-80일 때
